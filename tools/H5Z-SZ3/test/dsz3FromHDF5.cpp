...
int main(int argc, char *argv[]) {
    ...
    size_t nbEle = 0;
    char hdf5FilePath[640], outputFilePath[1024];
    ...
    snprintf(hdf5FilePath, sizeof(hdf5FilePath), "%s", argv[1]);
    snprintf(outputFilePath, sizeof(outputFilePath), "%s.out.h5", hdf5FilePath);
