#include <compressor/SZProgressiveInterpolationCompressor.hpp>
...
interp_compress_decompress(char *path, float *data, size_t num, double eb, int interp_level, int interp_op,
...

    {
        ...
        auto sz = SZ::SZProgressiveInterpolationCompressor<float, N, SZ::LinearQuantizer<float>, SZ::HuffmanEncoder<int>, SZ::Lossless_zstd>(
