#include <compressor/SZProgressiveInterpolationCompressorV2.hpp>
...
interp_compress_decompress(char *path, float *data, size_t num, double eb, int interp_level, int interp_op,
...

    {
        ...
        auto sz = SZ::SZProgressiveInterpolationCompressorV2<float, N, SZ::LinearQuantizer<float>, SZ::HuffmanEncoder<int>, SZ::Lossless_zstd>(
