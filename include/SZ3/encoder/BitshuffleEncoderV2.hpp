...
/**
 * @file BitshuffleEncoderV2.hpp
 * @ingroup Encoder
 */

#ifndef SZ3_BITSHUFFLEENCODER_V2_HPP
#define SZ3_BITSHUFFLEENCODER_V2_HPP
...
namespace SZ3 {
    ...
    template<class T>
    class BitshuffleEncoderV2 : public concepts::EncoderInterface<T> {
    public:
        BitshuffleEncoderV2(uint bits) : bits(bits) {}
